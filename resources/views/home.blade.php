...
<section class="main-title d-flex align-items-center">
    <div class="main-title__content content">
        <div class="main-title__content--text d-flex">
            <div>
                <h1 class="mb-3">
                    Embrace the <img class="img-fluid" loading="lazy" src="{{ asset('img/5g-icon.png') }}" alt="5g-icon"> era
                </h1>
                <p> We provide the tools to create, manage and connect to the next generation of 5G netapps</p>
            </div>

            <!-- <button type="button" class="btn btn--primary">Explore NetApps</button>                 -->
            <div>
            ...
            <div class="d-flex justify-start">
                <div class="explore__box me-5">
                    ...
                    <div class="explore__box--text">
                        <p class="text-note">Category 1 dolor sit amet, consetetur sadipscing elitr, sed diam nonumy
                            eirmod tempor
                            invidunt ut labore et dolore magna.</p>
                        <a href="{{ route('product-catalogue') }}" class="btn btn--primary mt-5">View NetApps</a>
                    </div>
                </div>
    ...
    <section class="for-whom u-margin-bottom-big">
        <div class="for-whom__content content">
            <div class="row for-creators mb-5">
                ...
                <div class="col-lg-6 for-creators--list pt-5 ps-5">
                    <ol>
                        <li>
            ...
            <div class="row for-businesses">
                <div class="col-lg-6 for-businesses--list pt-5 ps-5">
                    <ol>
                        <li>
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item mb-4">
                        ...
                        <div class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                            ...
                            <div class="accordion-body text-start">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
