                    ...
                    <template>
                        <div class="product-info__title--save d-flex justify-content-center align-items-center">
                            ...
                            @else
                                ...
                                @else
                                    <a href="#" @click="saveNetapp({{$netapp['id']}},{{auth()->user()->id}},true)"><i
            ...
            <div class="product-about d-flex flex-wrap mb-5">
                ...
                <div class="product-about__extra-info">
                    ...
                    <div
                        ...
                        <a href="http://evolved5g-marketplace-forum.evolved-5g.gr/c/support/2" target="blank"
                                    ...
                                    @if($netapp['purchased_netapp'] ==null)
                                        <div class="row">
                                            ...
                                            payment_plan_id: null,
                                                ...
                                                <!-- Modal -->
                                                <purchased-netapp-modal :open="this.showPurchasedModel"
                                                                        netapp-name="{{$netapp['name']}}"></purchased-netapp-modal>
                                        </div>
                                    @endif
                                </div>
                            </div>
