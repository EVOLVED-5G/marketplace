    ...
    <div id="welcome">
        ...
        <div class="bar-template row p-3 my-auto shadow align-items-center mb-5">
            <div class="col-xl-8 col-lg-6 my-auto">
                <h4>Connect your Network App to the marketplace</h4>
                <p class="mb-xl-0 mb-lg-4">If you have already used the <a href="https://evolved5g-cli.readthedocs.io/en/latest/" target="_blank">guide</a> and you already have Evolved&#8209;5G Network App created, click the upload button to connect to the marketplace.</p>
            </div>
